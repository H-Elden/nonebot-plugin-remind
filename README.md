...
> ✨ v0.2.0 新增：关键词触发现已支持**自然语言时间解析**（基于 [jionlp](https://github.com/dongrixinyu/JioNLP)），无需配置任何 API Key 即可使用「提醒我明天下午3点开会」「半小时后提醒我喝水」等自然语言表达。
...
- **[时间]**
    ...
    **关键词触发**默认使用 [jionlp](https://github.com/dongrixinyu/JioNLP) 进行自然语言时间解析，**无需配置任何 API Key**，支持以下格式：
...
示例：
1. `@机器人 16:00提醒我去开会`
2. `@机器人 提醒我明天下午3点去开会` ✨（v0.2.0 新增语序）
3. `@机器人 提醒我半小时后喝水` ✨
4. `机器人昵称，1.1.11.40提醒所有人去聚餐`
5. `机器人昵称 2025-1-29-8:00提醒我和@用户1 用户2 新年新气象！`
